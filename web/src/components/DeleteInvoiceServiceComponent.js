...
export default function DeleteInvoiceServiceComponent({id,refetch}) {
    ...
    const mutation=useMutation(values=>http.delete(`/invoice_services/${values}`).then(res=>res.data),{
        onSuccess:async()=>{
            refetch()

...
export default function PaymentComponent() {
    ...
    const mutation=useMutation(values=>http.post('/payments',values).then(res=>res.data),{
        onSuccess:async()=>{
            // await queryClient.invalidateQueries(['fee',id])
            await queryClient.invalidateQueries(['invoice-payments',id])
    ...
    return (
        <>
                ...
                >
                    <span className="block text-xs text-teal-700">Add Payment</span>
                </button>

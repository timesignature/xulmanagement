...
export default function DeletePaymentComponent({id,refetch}) {
    ...
    const mutation=useMutation(values=>http.delete(`/payments/${values}`).then(res=>res.data),{
        onSuccess:async()=>{
            refetch()
            success('payment has been removed')
            closeModal()
